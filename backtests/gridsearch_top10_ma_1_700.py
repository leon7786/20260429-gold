...
ASSETS = {
    ...
    'copper': BASE / 'data' / 'copper.csv',
    'natgas': BASE / 'data' / 'natgas.csv',
...
def run_asset(asset: str, path: Path):
    ...
    out_all = OUT_DIR / f'{asset}_ma_gridsearch_1_700_vs_1_700.csv'
...
def main():
    ...
    summary_path = OUT_DIR / 'top10_assets_best_ma_1_700_vs_1_700.csv'
