...
def main():
    ...
    res_path = OUT_DIR / 'gold_ma_gridsearch_1_400_vs_1_400.csv'
    res.to_csv(res_path, index=False)

    robust = res[res['trades'] >= 30].head(30)
    robust_path = OUT_DIR / 'gold_ma_gridsearch_1_400_vs_1_400_top30_trades_ge30.csv'
